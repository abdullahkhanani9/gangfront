...
<html lang="en">
    ...
    <script>
        ...
        function fetchUserData() {
            ...
            fetch(`https://backgang.stu.nighthawkcodingsociety.com/api/settings/get-user-name?uid=${uid}`)
        ...
        function fetchProfilePicture() {
            ...
            fetch(`https://backgang.stu.nighthawkcodingsociety.com/api/settings/get-profile-picture?uid=${uid}`)
                .then(response => response.json())
                .then(data => {
                    if (data.message) {
                        alert(data.message);
        ...
        function changeName() {
            ...
            fetch('https://backgang.stu.nighthawkcodingsociety.com/api/settings/change-name', {
                method: 'PUT',
        ...
        function changeUID() {
            ...
            fetch('http://backgang.stu.nighthawkcodingsociety.com/api/settings/change-uid', {
                method: 'PUT',
                headers: {'Content-Type': 'application/json'},
        ...
        function uploadImage() {
            ...
            fetch('http://backgang.stu.nighthawkcodingsociety.com/api/settings/profile-picture', {
                method: 'POST',
