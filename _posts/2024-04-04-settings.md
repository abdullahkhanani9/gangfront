...
<html lang="en">
    ...
    <div class="form-container">
        ...
        <p>The image below is your current profile picture. If there is no image, you either don't have a profile picture or an error occurred.</p>
        <img id="profilePicture" src="" alt="Profile Picture" style="max-width: 200px; border-radius: 50%; display: none;">
        <!-- Theme-changing form -->
        <h2>Change Theme</h2>
        ...
        <p>To upload a profile picture, simply click the "Browse" button and select a file from your computer (JPG, PNG, PDF) then click the "Upload Image" button to save it to your profile.</p>
    ...
    <script>
        ...
        function fetchUserData() {
            ...
            fetch(`http://127.0.0.1:8008/api/settings/get-user-name?uid=${uid}`)
        ...
        function fetchProfilePicture() {
            ...
            fetch(`http://127.0.0.1:8008/api/settings/get-profile-picture?uid=${uid}`)
                .then(response => response.json())
                .then(data => {
                    if (data.message) {
                        alert(data.message);
