...
<!-- settings.md -->
<!-- Frontend (JS, HTML, & CSS) below is individually-developed work -->
...
<html lang="en">
    ...
    <div class="form-container">
        ...
        <p>Your current user info is displayed here. Use this as a reference when changing your data.</p>
    ...
    <script>
        ...
        function fetchUserData() {
            ...
            fetch(`http://127.0.0.1:8008/api/settings/get-user-data?uid=${uid}`)
